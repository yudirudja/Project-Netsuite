            ...
            //  }
             ...
             for (var x = 0; x < tempDataSet.length; x++) {
                for (var k = 0; k < dataSetFinal.length; k++) {
                    ...
                    if (tempDataSet[x].transfer_order.documentNumber == dataSetFinal[k].transfer_order.documentNumber && dataSetFinal[k].data_receipt.type != "ItemShip") {
                        additionSubtotalTo += dataSetFinal[k].data_item.amount_order;
                        
                    }

                    
                }
                tempDataSet[x].transfer_order.amount_order_total = additionSubtotalTo;
                tempDataSet[x].transfer_order.sisa_amount_total = tempDataSet[x].transfer_order.amount_order_total  - tempDataSet[x].transfer_order.received_amount_total;
                additionSubtotalTo = 0;
