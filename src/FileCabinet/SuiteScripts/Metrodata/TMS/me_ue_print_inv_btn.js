...
define(["N/runtime", "N/record", "N/url"], function (runtime, record, url) {
    ...
    function beforeLoad(context) {
        ...
        if (context.type == context.UserEventType.VIEW) {
            ...
            var getCreatedFrom = newRec.getValue('createdfrom');
            ...
            if (getSalesCategory.includes('Foreign') && getProformaFinal.includes('Final') && getCreatedFrom) {
            ...
            } else if(!getSalesCategory.includes('Foreign') && getProformaFinal.includes('Final') && getCreatedFrom) {
                var param = {
                    record_id: record_id,
                    record_type: record_type,
                    // delegator: getDelegator,
