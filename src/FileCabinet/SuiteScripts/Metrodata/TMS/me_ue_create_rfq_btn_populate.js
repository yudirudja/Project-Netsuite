 ...
 */
define(["N/runtime", "N/record", "N/url", "./config/me_config_yudi.js"], function (runtime, record, url, config) {
    ...
    function afterSubmit(context) {
        ...
        if (countIsRfqed == getLineItemCount) {
            var setRfqCurr = loadPr.setValue('custbody_me_pr_currency', getCurr);
