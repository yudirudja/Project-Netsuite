        ...
        var getKurs = search.create({
            ...
            columns:
                [
                    ...
                    search.createColumn({ name: "custrecord_me_exchange_rates", label: "ME - Exchange Rates" }),
                            ...
                            // if (getTaxCodeId) {
                                ...
                                if (getCurrency.includes('IDR') && !getTaxCodeText.includes('PPN 0%')) {
                                    ...
                                    var setFakturPajakBounded = rec.setCurrentSublistValue({
                                        ...
                                        line: i,
                                        value: parseFloat((Number(getKursPajak) + Number(getOtherRate)) * (Number(getLme) + Number(getPremium) + Number(getMjp) + Number(getOther))).toFixed(2) * Number(getQuantity),
                                        ignoreFieldChange: true
                                    })
                                    var setFakturPajakBoundedPpn = rec.setCurrentSublistValue({
                                        ...
                                        line: i,
                                        value:  parseFloat((Number(getKursPajak) + Number(getOtherRate)) * (Number(getLme) + Number(getPremium) + Number(getMjp) + Number(getOther))).toFixed(2) * Number(getQuantity) * (getTaxRate / 100),
                                        ignoreFieldChange: true
                                    })
                                ...
                                if (getCurrency.includes('IDR') && getTaxCodeText.includes('PPN 0%')) {
                                    ...
                                    var setFakturPajakBoundedPpn = rec.setCurrentSublistValue({
                                        ...
                                        fieldId: 'custcol_me_ppn_idr',
                                        line: i,
                                        value:  parseFloat((Number(getKursPajak) + Number(getOtherRate)) * (Number(getLme) + Number(getPremium) + Number(getMjp) + Number(getOther))).toFixed(2) * Number(getQuantity) * (0.11),
                                        ignoreFieldChange: true
                                    })
                                    var setTaxAmt = rec.setCurrentSublistValue({
                                        sublistId: 'item',
                                ...
                                if (getCurrency.includes('US') && !getTaxCodeText.includes('PPN 0%')) {
                                    var setUnitPriceBounded = rec.setCurrentSublistValue({
                                        ...
                                        fieldId: 'custcol_me_unit_price_bounded_zone',
                                        line: i,
                                        value:  parseFloat((Number(getKursPajak) + Number(getOtherRate)) * (Number(getLme) + Number(getPremium) + Number(getMjp) + Number(getOther))).toFixed(2),
                                        ignoreFieldChange: true
                                    })
                                    var setFakturPajakBounded = rec.setCurrentSublistValue({
                                        sublistId: 'item',
        ...
        if(sublistId == "item") {
            ...
            if ((fieldId == "rate") || ((fieldId == "taxcode") && getOtherF == 0 && getOtherP == 0 && getOthRateF == 0 && getOthRateP == 0 && getPreF == 0 && getPreP == 0 && getLmeF == 0 && getLmeP == 0 && getMjpF == 0 && getMjpP == 0)) {
                ...
                if (getTaxCodeId) {
                    ...
                    log.debug("tax rate", getTaxRate)
                    if (getCurrency.includes('IDR') && rec.getText('custbody_me_bounded_zone') == 'Yes' && (!getTaxCode.includes('PPN 0%') && !getTaxCode.includes('UNDEF'))) {
                        if (!(rec.type).includes('salesorder')) {
                            var setUnitPriceBounded = rec.setCurrentSublistValue({
                                sublistId: 'item',
                                fieldId: 'custcol_me_unit_price_bounded_zone',
                                // line: i,
