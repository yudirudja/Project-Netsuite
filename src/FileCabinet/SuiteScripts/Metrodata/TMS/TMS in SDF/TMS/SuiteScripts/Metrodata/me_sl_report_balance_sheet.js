            ...
            columns:
                [
                    ...
                    search.createColumn({
                        name: "formulanumeric",
                        summary: "SUM",
                        formula: "case when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Accounts Payable%' then ({debitamount}*-1) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Equity%' then ({debitamount}*-1) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Income%' then ({debitamount}*-1) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Other Income%' then ({debitamount}*-1) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Long Term Liability%' then ({debitamount}*-1) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Other Current Liability%' then ({debitamount}*-1) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Accounts Payable%' then ({debitamount}) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Income%' then ({debitamount}) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Other Income%' then ({debitamount}) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Long Term Liability%' then ({debitamount}) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Other Current Liability%' then ({debitamount})else 0 end",
                        label: "Debit"
                    }),
                    search.createColumn({
                        name: "formulanumeric",
                        summary: "SUM",
                        formula: "case when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Accounts Payable%' then ({creditamount}) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Equity%' then ({creditamount}) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Income%' then ({creditamount}) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Other Income%' then ({creditamount}) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Long Term Liability%' then ({creditamount}) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Other Current Liability%' then ({creditamount}) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Accounts Payable%' then ({creditamount}*-1) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Income%' then ({creditamount}*-1) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Other Income%' then ({creditamount}*-1) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Long Term Liability%' then ({creditamount}*-1) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Other Current Liability%' then ({creditamount}*-1)else 0 end",
                        label: "Credit"
                    }),
                    search.createColumn({
                        name: "number",
            ...
            columns:
                [
                    ...
                    search.createColumn({
                        name: "formulanumeric",
                        summary: "SUM",
                        formula: "case when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Accounts Payable%' then ({debitamount}*-1) when {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Income%' then ({debitamount}*-1) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Other Income%' then ({debitamount}*-1) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Long Term Liability%' then ({debitamount}*-1) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Other Current Liability%' then ({debitamount}*-1) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Accounts Payable%' then ({debitamount}) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Income%' then ({debitamount}) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Other Income%' then ({debitamount}) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Long Term Liability%' then ({debitamount}) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Other Current Liability%' then ({debitamount})else 0 end",
                        label: "Debit"
                    }),
                    search.createColumn({
                        name: "formulanumeric",
                        summary: "SUM",
                        formula: "case when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Accounts Payable%' then ({creditamount}) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Income%' then ({creditamount}) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Other Income%' then ({creditamount}) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Long Term Liability%' then ({creditamount}) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Other Current Liability%' then ({creditamount}) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Accounts Payable%' then ({creditamount}*-1) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Income%' then ({creditamount}*-1) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Other Income%' then ({creditamount}*-1) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Long Term Liability%' then ({creditamount}*-1) when {custbody_me_post_period} like 'Adjust%' and {trandate} >= TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') AND {trandate} <= TO_DATE(" + "'" + params.end + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Other Current Liability%' then ({creditamount}*-1)else 0 end",
                        label: "Credit"
                    }),
                ]
        });
            ...
            columns:
                [
                    ...
                    search.createColumn({
                        name: "formulanumeric",
                        summary: "SUM",
                        formula: "case when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Accounts Payable%' then ({debitamount}*-1) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Equity%' then ({debitamount}*-1) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Income%' then ({debitamount}*-1) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Other Income%' then ({debitamount}*-1) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Long Term Liability%' then ({debitamount}*-1) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Other Current Liability%' then ({debitamount}*-1) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Accounts Payable%' then ({debitamount}) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Income%' then ({debitamount}) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Other Income%' then ({debitamount}) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} like '%Long Term Liability%' then ({debitamount}) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {debitamount} is not null and {account.type} not like '%Other Current Liability%' then ({debitamount})else 0 end",
                        label: "Formula (Numeric)"
                    }),
                    search.createColumn({
                        name: "formulanumeric",
                        summary: "SUM",
                        formula: "case when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Accounts Payable%' then ({creditamount}) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Equity%' then ({creditamount}) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Income%' then ({creditamount}) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Other Income%' then ({creditamount}) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Long Term Liability%' then ({creditamount}) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Other Current Liability%' then ({creditamount}) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Accounts Payable%' then ({creditamount}*-1) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Income%' then ({creditamount}*-1) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Other Income%' then ({creditamount}*-1) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} like '%Long Term Liability%' then ({creditamount}*-1) when {trandate} < TO_DATE(" + "'" + params.start + "'" + ", 'D/M/YYYY') and {creditamount} is not null and {account.type} not like '%Other Current Liability%' then ({creditamount}*-1)else 0 end",
                        label: "Formula (Numeric)"
                    }),
                    search.createColumn({
                        name: "number",
    ...
    function printHtmlNonClosing(form, final, context, param, get_retained_earning) {
        ...
        for (let p = 0; p < final.length; p++) {
            ...
            salesReport.defaultValue +=
                ...
                '<td >' + addComa(Number(final[p].debit)) + '</td>' +
                '<td >' + addComa((Number(final[p].credit))) + '</td>' +
        ...
        salesReport.defaultValue +=
            ...
            '<td >' + addComa(Number(get_retained_earning[0].posted_retained_earning_debit)) + '</td>' +
            '<td >' + addComa((Number(get_retained_earning[0].retained_earning)) + Number(get_retained_earning[0].posted_retained_earning_credit)) + '</td>' +
        ...
        if (context.request.method === 'GET') {
            ...
            if (category == 1) {
                ...
                if (isAccountParent == "T") {
                    var print_excel = printHtmlNonClosing(form, is_account_parent, context, param, get_retained_earning)
                } else {
                    var print_excel = printHtmlNonClosing(form, combine_saved_search, context, param, get_retained_earning)
            ...
            if (category == 2) {
                ...
                var get_balance_sheet_opening = balanceSheetOpeningSearch(param, get_balance_sheet_account)
                var combine_saved_search = combine(get_balance_sheet, get_balance_sheet_opening)
                var print_excel = printHtmlClosing(form, combine_saved_search, context, param, get_retained_earning)
            }
        }
