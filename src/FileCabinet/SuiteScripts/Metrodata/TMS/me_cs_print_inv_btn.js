    ...
    function onButtonClick(param){
        ...
        try {
            ...
            var urlPrintout = url.resolveScript({
                scriptId: 'customscript_me_sl_inv_exp_dom',//Please make sure to replace this with the script ID of your Suitelet
                deploymentId: 'customdeploy_me_sl_inv_exp_dom',//Please make sure to replace this with the deployment ID of your Suitelet
                params: {
