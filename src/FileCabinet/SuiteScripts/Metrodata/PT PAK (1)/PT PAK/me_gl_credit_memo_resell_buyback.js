    ...
    try {
        ...
        if (dataItem.length > 0) {
            for (var a = 0; a < dataItem.length; a++) {
                ...
                nlapiLogExecution("DEBUG", "1 credit memo", "Line Debit AR created")
                ...
                nlapiLogExecution("DEBUG", "2 credit memo", "Line Credit Revenue created")
                ...
                nlapiLogExecution("DEBUG", "3 credit memo", "Line Debit COGS created")
                ...
                nlapiLogExecution("DEBUG", "4 credit memo", "Line Credit Inventory created")
