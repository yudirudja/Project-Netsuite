...
define(['N/ui/serverWidget', 'N/search'], function (serverWidget, search) {
    ...
    function getPnlSavedSearch(data) {
        ...
        do {
            ...
            for (let x = 0; x < toResult.length; x++) {
                ...
                var getAccountInternalId = toResult[x].getValue(toResult[x].columns[5]);
                result.push({
                    account_internal_id: getAccountInternalId,
    ...
    function printHtml(form, pnlData, context) {
        ...
        var accountListArr = [
            [{accNo:'4-1001000', name: 'Penjualan Diamond Jewelry'}, {accNo:'4-1002000', name: 'Penjualan Gold Jewelry'}, {accNo:'4-1003000', name: 'Penjualan Loose Stone'}, {accNo:'4-1004000', name: 'Penjualan Logam Mulia'}],
            [{accNo:'4-1001000', name: 'Penjualan Diamond Jewelry'}, {accNo:'4-1002000', name: 'Penjualan Gold Jewelry'}, {accNo:'4-1003000', name: 'Penjualan Loose Stone'}, {accNo:'4-1004000', name: 'Penjualan Logam Mulia'}],
            [{accNo:'4-4001001', name: 'Potongan Penjualan PL Diamond Jewelry'}, {accNo:'4-4001002', name: 'Potongan Penjualan PL Gold Jewelry'}, {accNo:'4-4001003', name: 'Potongan Penjualan PL Loose Stone'}, {accNo:'4-4001004', name: 'Potongan Penjualan PL Logam Mulia'}],
        ]
        ...
        for (let a = 0; a < accountListArr.length; a++) {
            for (let z = 0; z < accountListArr[a].length; z++) {
                pnlReport.defaultValue +=
                    '<tr class="table-row">' +
                    '<td class="table-column">' + accountListArr[a][z].accNo + '</td>' +
                    '<td class="table-column">' + accountListArr[a][z].name + '</td>';
                for (let x = 0; x < locList.length; x++) {
                    for (let i = 0; i < pnlData.length; i++) {
                        if (pnlData[i].account == accountListArr[a][z].accNo && locList[x].loc_id == pnlData[i].location) {
