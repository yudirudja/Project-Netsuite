...
define(["N/runtime", "N/record", "N/url", "N/search"], function (runtime, record, url, search) {
    ...
    function beforeLoad(context) {
        ...
        if (context.type == context.UserEventType.VIEW) {
            ...
            log.debug("getRelated bool",get_related.includes("Invoice"))

            if (!get_related.includes("Invoice") && !get_intercompany) {
                ...
                try {
                    ...
                    context.form.clientScriptModulePath = 'SuiteScripts/Metrodata/transform_so_to_inv/me_cs_transform_so_to_inv_button.js'
                } catch (error) {
